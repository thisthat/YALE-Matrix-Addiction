...
for i in `seq 2 2 80`;
do
    echo ./YSFMMoltiplication -row 500 -col 500 -fill 5 -s 0 -t ${i} -f strategy_0_multiple_thread.csv
         ./YSFMMoltiplication -row 500 -col 500 -fill 5 -s 0 -t ${i} -f strategy_0_multiple_thread.csv
    echo ./YSFMMoltiplication -row 500 -col 500 -fill 5 -s 1 -t ${i} -f strategy_1_multiple_thread.csv
         ./YSFMMoltiplication -row 500 -col 500 -fill 5 -s 1 -t ${i} -f strategy_1_multiple_thread.csv

    echo ./YSFMMoltiplication -row 500 -col 500 -fill 5 -s 2 -t ${i} -f strategy_2_multiple_thread.csv
         ./YSFMMoltiplication -row 500 -col 500 -fill 5 -s 2 -t ${i} -f strategy_2_multiple_thread.csv
